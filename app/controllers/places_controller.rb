class PlacesController < ApplicationController
  ...
  def place_params
    params.require(:place).permit(:name, :cover_image, :description, :address, :category, :indoor_outdoor, :parking, :min_age, :max_age, :adult_price, :child_price, :opening_time, :closing_time, sub_images: [])
  end
